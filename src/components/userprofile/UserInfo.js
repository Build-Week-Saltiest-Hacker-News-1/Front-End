       ...
       <CardTitle style={{ margin: "auto", marginTop: "1rem",  fontWeight: "bold", fontSize: "2rem" }}>
          ...
          <hr/>
            <CardBody>
              ...
              <CardText style={{  fontSize: "1.2rem" }} >{props.userInfo.name}</CardText>
              <br />
              <Label style={{ fontWeight: "bold", fontSize: "1.5rem" }}>Username</Label>
              <CardText style={{  fontSize: "1.2rem" }} >{props.userInfo.user}</CardText>
              <br/>
              <Label style={{ fontWeight: "bold", fontSize: "1.5rem" }}>Email</Label>
              <CardText  style={{  fontSize: "1.8rem" }}  >{props.userInfo.email}</CardText>
              <br />
